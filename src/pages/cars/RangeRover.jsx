...
export default function RangeRover() {
  const galleryImages = [
    `${import.meta.env.BASE_URL}images/rangerover/rover1.jpg`,
    `${import.meta.env.BASE_URL}images/rangerover/rover2.png`,
    `${import.meta.env.BASE_URL}images/rangerover/rover3.jpg`,
    `${import.meta.env.BASE_URL}images/rangerover/rover4.jpg`,
    `${import.meta.env.BASE_URL}images/rangerover/rover5.jpg`
  ]
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-start">
          ...
          >
            <div className="rounded-xl sm:rounded-2xl overflow-hidden shadow-xl sm:shadow-2xl">
              <OptimizedImage
                src={`${import.meta.env.BASE_URL}images/Range Rover.png`}
                alt="Range Rover"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-gray-600">
              Explore more views of the Range Rover
            </p>
          </motion.div>
