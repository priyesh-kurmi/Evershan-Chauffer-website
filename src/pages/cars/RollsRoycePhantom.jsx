...
export default function RollsRoycePhantom() {
  const galleryImages = [
    `${import.meta.env.BASE_URL}images/phantom/phantom1.jpg`,
    `${import.meta.env.BASE_URL}images/phantom/phantom2.png`,
    `${import.meta.env.BASE_URL}images/phantom/phantom3.png`,
    `${import.meta.env.BASE_URL}images/phantom/phantom4.jpg`
  ]
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-start">
          ...
          >
            <div className="rounded-xl sm:rounded-2xl overflow-hidden shadow-xl sm:shadow-2xl">
              <OptimizedImage
                src={`${import.meta.env.BASE_URL}images/Rolls-Royce Phantom.png`}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-gray-600">
              Explore more views of the Rolls-Royce Phantom
            </p>
          </motion.div>
            ...
            {galleryImages.map((image, index) => (
              ...
              >
                <div className="aspect-video overflow-hidden">
                  <OptimizedImage
                    src={image}
                    alt={`Rolls-Royce Phantom view ${index + 1}`}
